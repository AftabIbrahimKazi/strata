...
> A Three.js-powered interactive chart component with 2D/3D toggle for [Strata CSS](https://github.com/AftabIbrahimKazi/strata). Supports bar, line, pie, and scatter charts. Works standalone or with Strata CSS.

[![npm](https://img.shields.io/npm/v/@strata-packages/chart)](https://www.npmjs.com/package/@strata-packages/chart)
[![license](https://img.shields.io/npm/l/@strata-packages/chart)](LICENSE)
...
Full API reference, options and live examples: **[https://strata-css-docs-site.vercel.app/packages/chart](https://strata-css-docs-site.vercel.app/packages/chart)**

`@strata-packages/chart` is part of **[Strata CSS](https://github.com/AftabIbrahimKazi/strata)** — a JIT CSS framework that pairs Bootstrap-style component classes with Tailwind-style on-demand generation, cascade layers instead of `!important`, variants (`hover:`, `group-hover:`, `peer-checked:`), arbitrary values and three built-in themes.
